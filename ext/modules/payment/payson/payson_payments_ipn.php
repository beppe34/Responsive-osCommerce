...
*/
	...
	{
		if(file_exists(DIR_FS_CATALOG . "includes/modules/payment/payson_payments_invoice.php"))
        {
			include_once(DIR_FS_CATALOG . "includes/modules/payment/payson_payments_invoice.php");
		...
		else
		{
			...
			error_log("Payson Invoice Module not found: " . DIR_FS_CATALOG . "includes/modules/payment/payson_payments_invoice.php", 0);
		}
	}
