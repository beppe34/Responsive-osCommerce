...
*/
  ...
  define('MODULE_NAVBAR_BRAND_PUBLIC_TEXT', '<a class="navbar-brand" href="' . tep_href_link('index.php') . '">' . tep_image( 'images/' . STORE_LOGO, STORE_NAME,null,50,'style="position:absolute;top:3px;"' ) . '</a>');
