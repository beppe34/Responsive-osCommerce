...
*/
  ...
  define('MODULE_NAVBAR_ACCOUNT_LOGIN', '<i class="fa fa-sign-in"></i> Logga In');
  define('MODULE_NAVBAR_ACCOUNT_LOGOFF', '<i class="fa fa-sign-out"></i> Logga Ut');
  define('MODULE_NAVBAR_ACCOUNT', 'Mitt konto');
  define('MODULE_NAVBAR_ACCOUNT_HISTORY', 'Mina Ordrar');
