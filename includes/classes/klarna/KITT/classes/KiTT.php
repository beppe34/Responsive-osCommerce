...
define('KITT_DATA', dirname(KITT_CLASS) . '/data');
...
require_once KITT_INT . '/Checkout/Controller.php';
require_once KITT_INT . '/Payment/Option.php';

require_once KITT_CLASS . '/CountryLogic.php';
require_once KITT_CLASS . '/Exception.php';
require_once KITT_CLASS . '/JSONLanguagePack.php';
...
require_once KITT_CLASS . '/Installment/Controller/Abstract.php';
require_once KITT_CLASS . '/View/Helper.php';
require_once KITT_CLASS . '/Widget.php';
require_once KITT_CLASS . '/Installment/Widget.php';
require_once KITT_CLASS . '/Product/Controller.php';
require_once KITT_CLASS . '/Cart/Controller.php';
...
// Supressed include for a possibility to change xmlrpc host
@include_once KITT_DATA . '/data/host.php';
