...
/*
  ...
  Modified for:
  2015 wholesale (SPPC Lite) 1.4 by @raiwa info@oscaddons.com
...
// class constructor
    function payment($module = '') {
      global $payment, $language, $PHP_SELF;
    	global $customer_id; // wholesale (SPPC Lite)
      global $order; // PWA Guest Checkout
      ...
      if (defined('MODULE_PAYMENT_INSTALLED') && tep_not_null(MODULE_PAYMENT_INSTALLED)) {
      	...
      	// PWA Guest Checkout END
    			...
    			if (tep_not_null($temp_payment_array)) { // remove excluded shipping modules
