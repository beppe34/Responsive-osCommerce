...
class klarna_SpecCamp extends KlarnaBase
{
    ...
    public function __construct()
    {
        ...
        $this->sort_order = MODULE_PAYMENT_SPECKLARNA_SORT_ORDER;
    ...
    public function keys()
    {
        ...
        $keys = array(
            'MODULE_PAYMENT_SPECKLARNA_STATUS',
            'MODULE_PAYMENT_SPECKLARNA_LASTESTVERSION',
            'MODULE_PAYMENT_SPECKLARNA_LIVEMODE'
        );
        foreach (KiTT::supportedCountries() as $country) {
            $keys[] = "MODULE_PAYMENT_SPECKLARNA_EID_{$country}";
            $keys[] = "MODULE_PAYMENT_SPECKLARNA_SECRET_{$country}";
            if (KiTT::countryLogic(KiTT::locale($country))->needAGB()) {
                $keys[] = "MODULE_PAYMENT_SPECKLARNA_AGB_LINK_{$country}";
            }
        }
        $keys = array_merge(
            $keys,
            array(
                ...
                'MODULE_PAYMENT_SPECKLARNA_ORDER_STATUS_ID',
                'MODULE_PAYMENT_SPECKLARNA_ORDER_STATUS_PENDING_ID',
                'MODULE_PAYMENT_SPECKLARNA_SORT_ORDER',
                'MODULE_PAYMENT_SPECKLARNA_ZONE',
                'MODULE_PAYMENT_SPECKLARNA_ARTNO'
            )
        );
        return $keys;
    }
