  ...
  if (tep_not_null($action)) {
    switch ($action) {
      case 'update_order':
        ...
        $order_updated = false;
// PWA guest checkout
        $check_status_query = tep_db_query("select customers_name, customers_guest, customers_email_address, orders_status, date_purchased from orders where orders_id = '" . (int)$oID . "'");
